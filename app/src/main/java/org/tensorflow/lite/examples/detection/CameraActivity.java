...
import org.tensorflow.lite.examples.detection.tflite.Detector.Language;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    @UiThread
    protected void showResultsInBottomSheet(List<Detector.Detection> results) {
        Detector.Detection detection = null;
        Detector.Detection detection1 = null;
        Detector.Detection detection2 = null;

        if (results != null && results.size() >= 1 && !dialogIsOpen && !sheetIsOpen) {
            detection = results.get(0);
            if (results.size() >= 2)
                detection1 = results.get(1);
            if (results.size() >= 3)
                detection2 = results.get(2);

            String firstPosition = detection.getTitle();
            ...
            if (detection.getTitle() != null) recognitionTextView.setText(detection.getTitle());
            if (detection.getConfidence() != null)
                recognitionValueTextView.setText(
                        //String.format("%.2f", (100 * recognition.getConfidence())) + "%"
                        detection.getConfidence().toString()
                );


            if (detection1 != null) {
                if (detection1.getTitle() != null)
                    recognition1TextView.setText(detection1.getTitle());
                if (detection1.getConfidence() != null)
                    recognition1ValueTextView.setText(
                            //String.format("%.2f", (100 * recognition1.getConfidence())) + "%"
                            detection1.getConfidence().toString()
                    );
            }

            if (detection2 != null) {
                if (detection2.getTitle() != null)
                    recognition2TextView.setText(detection2.getTitle());
                if (detection2.getConfidence() != null)
                    recognition2ValueTextView.setText(
                            //String.format("%.2f", (100 * recognition2.getConfidence())) + "%"
                            detection2.getConfidence().toString()
                    );
            }
            ...
            if (recognitionList.size() >= 3) {
                ...
                Detector.Detection finalDetection = detection;
                ...
                recognizedMonumentTextView.setText(finalDetection.getTitle());
                ...
                moreInfoButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra("monument_id", finalDetection.getId());
