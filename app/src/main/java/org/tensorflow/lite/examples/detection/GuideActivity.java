...
public class GuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // map to new labels (object detection) @eliainnocenti
        switch (monumentId) {
            case "1":
                monumentId = "Cattedrale Duomo";
                break;
            case "2":
                monumentId = "Battistero SanGiovanni";
                break;
            case "3":
                monumentId = "Campanile Giotto";
                break;
            case "4":
                monumentId = "Galleria degli Uffizi"; // TODO: implement
                break;
            case "5":
                monumentId = "Loggia dei Lanzi"; // TODO: implement
                break;
            case "6":
                monumentId = "Palazzo Vecchio";
                break;
            case "7":
                monumentId = "Ponte Vecchio"; // TODO: implement
                break;
            case "8":
                monumentId = "Basilica di Santa Croce"; // TODO: implement
                break;
            case "9":
                monumentId = "Palazzo Pitti"; // TODO: implement
                break;
            case "10":
                monumentId = "Piazzale Michelangelo"; // TODO: implement
                break;
            case "11":
                monumentId = "Basilica di Santa Maria Novella"; // TODO: implement
                break;
            case "12":
                monumentId = "Basilica di San Miniato al Monte"; // TODO: implement
                break;
            default:
                break;
        }
